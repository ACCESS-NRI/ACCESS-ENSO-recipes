...
def plot_level1(obs_ds, model_ds, title, metric_varls): #SST_NHF = ['sst_east', 'nhf_east_mod', 'nhf_east_obs']
...
def plot_level2(obs_ds, model_ds, metric_varls, ds_labels):
    ...
    plt.subplot(122)
    obs1, obs2 = obs_extract_overlap(obs_ds[metric_varls[0]], obs_ds[metric_varls[2]])
...
def plt_settings(slopes, lvl1, metric_varls):
    ...
    var_set = {'sst':(5,'°C'), 'taux':(100,'1e-3 N/m2'), 'nhf':(100,'W m-2'),'ssh':(40,'cm'), 
